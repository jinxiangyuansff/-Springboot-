    ...
    public void getKaptcha(HttpServletResponse httpServletResponse, HttpSession httpSession) {
      ...
      //  httpSession.setAttribute("kaptcha", text);
       ...
       httpServletResponse.addCookie(cookie);
        ...
        public String login(String username, String password, String code, boolean rememberme, Model model, HttpSession httpSession, HttpServletResponse httpServletResponse, @CookieValue("kaptchaOwner") String kaptchaOwner) {
                // 检查验证码
